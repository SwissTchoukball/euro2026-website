<template>
  <section v-if="planningOverview.current_games.length > 0" class="l-section">
    ...
    <euro-game-list :games="planningOverview.current_games" hide-date-headings />
  </section>
  ...
  <section v-if="planningOverview.next_games.length > 0" class="l-section">
    ...
    <euro-game-list :games="planningOverview.next_games" hide-date-headings />
  </section>
  ...
  <section v-if="planningOverview.last_games.length > 0" class="l-section">
    ...
    <euro-game-list :games="planningOverview.last_games" hide-date-headings />
  </section>
